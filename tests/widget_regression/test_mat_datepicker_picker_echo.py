...
Fixture: `fixtures/mat_datepicker_picker_echo/` — sliced from SIMULADOR
...
def _normalize():
    return RecordingNormalizer().normalize(
        ...
        application="test",
        base_url="https://sintetico-tqs.example.com/home",
    )
...
@pytest.mark.xfail(reason="Fixture URL sanitizada para release v0.1.0. Reajustar detector/fixture em v0.2.0.", strict=False)
