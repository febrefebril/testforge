...
producao (banco SIMULADOR), o input de data tem uma mascara que suprime o evento
...
def test_click_only_date_selection_keeps_all_clicks():
    """Forma SIMULADOR: toggle + navegacao + clique em celula de dia, sem fill subsequente."""
