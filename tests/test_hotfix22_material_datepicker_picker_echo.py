...
Regressao (test-pos-hotfix22, SIMULADOR): quando o usuario seleciona uma data via
...
def _siopi_sequence(fill_placeholder="DD/MM/AAAA", fill_element_id=""):
    """SIMULADOR datepicker sequence: toggle + period + prev*2 + year + month + day + fill echo."""
    return [
...
def test_picker_echo_fill_via_placeholder_keeps_clicks():
    """SIMULADOR-shaped: placeholder DD/MM/AAAA on fill target → picker echo.
