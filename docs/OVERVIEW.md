...
**🎯 Diagnostic Mode (✅ v0.1.0)** — Sprint 0: FrameworkDetector, CaptureQuality, ReplayCheck, GherkinWriter, TelemetryStore
...
**🎯 ComponentHandler System (✅ v0.1.0)** — Sprints 1-6: Angular Material completo + PrimeFaces/React MUI skeletons

**🎯 Native Playwright Locators + Auto-Healing (✅ v0.1.0)** — Compiler gera get_by_role/label/placeholder; L0.5 fuzzy regex; compound multi-attr candidates; HealCatalog auto-learning; IntentReconstructor merged em RecordingNormalizer
...
R: Sim, qualquer SPA (React, Angular, Vue) ou site clássico. Testado com CORPORATIVO, Simulador Habitacional.
