...
def test_gap01_resolver_should_fall_to_next_candidate_when_first_fill_rejects():
    ...
    Bug original: rodadas SIMULADOR 15b-e, hotfix22 — 14-64% assert_hit_rate.
    """
    # Arrange
    page = MagicMock()
...
- Rec base SIMULADOR + hotfix22 + hotfix27 executam via `testforge run-incremental` e reportam `assert_hit_rate`.
