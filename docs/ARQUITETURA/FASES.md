...
**Sprint 0 (30+ bugs corrigidos):** Veja [CHANGELOG v0.1.0](../CHANGELOG.md) para lista completa.
...
### 🧩 ComponentHandler System (v0.1.0)
...
testforge/
├── src/testforge/
│   ├── handlers/               # [v0.1.0] ComponentHandler system
│   │   ├── __init__.py         # Registry + detect_handler()
...
│   │
│   ├── diagnostic/             # [v0.1.0] Sprint 0 — Diagnostic Mode
...
│   │
│   ├── recorder/
│   │   ├── overlay_inject.js       # [v0.1.0] JS overlay extraído
