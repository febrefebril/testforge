...
| BUG-007 | Tela pisca CONSULTA — navegações múltiplas | 🟢 Bloqueante | recorder_controller.py |
...
#### BUG-007: Tela pisca CONSULTA

**Arquivo:** `recorder_controller.py:544-571`

**Problema:** `_on_framenavigated` gera `navigation` event para toda navegação, mesmo quando é reload da mesma URL (CONSULTA faz pós-back).
