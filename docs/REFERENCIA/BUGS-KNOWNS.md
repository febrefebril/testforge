...
1. **5 Bugs Corrigidos** — Implementados e validados em v0.1.0 (commit c5c1d01)
2. **20 Bugs Abertos** — Identificados em fase de teste corporativo (CONSULTA, CORPORATIVO)
...
## ✅ Seção 1: Bugs Corrigidos em v0.1.0
...
## ✅ Seção 1.5: Bugs Corrigidos em v0.1.0 (Sprints 1-6)
...
**Problema:** Contenteditable detection falso positivo em elementos não editáveis. Datepicker dedup falhando em Angular com padrão CORPORATIVO.
...
### BUG-DEDUP-001: CORPORATIVO datepicker pattern + --debug-healing
...
**Problema:** Datepicker da CORPORATIVO com padrão diferente de Angular — não era deduplicado.

**Correção:** Adicionado padrão CORPORATIVO ao detector de datepicker. `--debug-healing` adicionado ao `run-incremental`.
...
Impossível usar em ambiente corporativo CORPORATIVO.

**Esperado:** Fallback: Playwright → Edge/Chrome instalado → CDP → recorder externo.

---

#### BUG-007: Tela pisca CONSULTA (P0)
