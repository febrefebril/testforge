...
- Fase C: Validação piloto com 5 gravações CORPORATIVO
...
- `c4-container.puml` ✅ — Add handlers/ namespace, bump v0.1.0
...
Cada milestone (v0.1.0, v0.1.0, v0.5.0, etc.) deve:
1. Atualizar versão em todos os `.puml` (título)
2. Regenerar PNGs
3. Committar com tag: `git tag -a v0.1.0-diagrams -m "Diagrams v0.1.0"`

### v0.1.0 (2026-06-30) — Diagramas atualizados (Sprint 0)
...
- `c4-container.puml`, `componentes-llm-healing.puml`, `fluxograma-pipeline-v1.puml` updated for v0.1.0
- `c4-context-v1.puml`, `componentes-v1.puml` bumped to v0.1.0
- Diagnostic mode + v2 architecture + Sprint 0 features reflected
- 20+ PUML files + PNGs regenerated

### v0.1.0 (2026-06-24) — Diagramas atualizados (Phase 1-7)
