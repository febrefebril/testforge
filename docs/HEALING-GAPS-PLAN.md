...
**Branch base**: `feature/inline-overlay-prompt` (base `fix/improvements-v0.1.0`)
...
- `recordings/test-pos-hotfix22/` — SIMULADOR banco full flow — `assert_hit_rate` atual 64%
...
class TestGap01ResolverRetryChain:
    ...
    Bug histórico: SIMULADOR 15b-e, hotfix22 — assert_hit_rate 14-64%.
    """
...
- Análise SIMULADOR 15b-e: `[[project-simulador-15-run-analysis]]`.
