...
class TestcaixaValidacaoPosCorrecaoAssert:
    ...
    def test_run(self, page: Page):
        ...
        for _sel in ['button[aria-label="Previous 24 years"]', 'button.mat-calendar-previous-button.mdc-icon-button.mat-mdc-icon-button.mat-unthemed.mat-mdc-button-base.cdk-focused.cdk-mouse-focused']:
            ...
            raise AssertionError('click falhou: ' + str(['button[aria-label="Previous 24 years"]', 'button.mat-calendar-previous-button.mdc-icon-button.mat-mdc-icon-button.mat-unthemed.mat-mdc-button-base.cdk-focused.cdk-mouse-focused']))
        ' Passo 7: click'
        ' Seletores: button[aria-label="1970"] | button:has-text("1970") | button.mat-calendar-body-cell.mat-calendar-body-active'
        for _sel in ['button[aria-label="1970"]', 'button:has-text("1970")', 'button.mat-calendar-body-cell.mat-calendar-body-active']:
            try:
                page.click(_sel)
                break
            except Exception:
            ...
            raise AssertionError('click falhou: ' + str(['button[aria-label="1970"]', 'button:has-text("1970")', 'button.mat-calendar-body-cell.mat-calendar-body-active']))
        ' Passo 8: click'
        ' Seletores: button[aria-label="fevereiro 1970"] | button:has-text("FEV") | button.mat-calendar-body-cell.mat-calendar-body-active'
        for _sel in ['button[aria-label="fevereiro 1970"]', 'button:has-text("FEV")', 'button.mat-calendar-body-cell.mat-calendar-body-active']:
            try:
                page.click(_sel)
                break
            except Exception:
            ...
            raise AssertionError('click falhou: ' + str(['button[aria-label="fevereiro 1970"]', 'button:has-text("FEV")', 'button.mat-calendar-body-cell.mat-calendar-body-active']))
        ' Passo 9: click'
        ' Seletores: button[aria-label="03/02/1970"] | button:has-text("3") | button.mat-calendar-body-cell.mat-calendar-body-active'
        for _sel in ['button[aria-label="03/02/1970"]', 'button:has-text("3")', 'button.mat-calendar-body-cell.mat-calendar-body-active']:
            try:
                page.click(_sel)
                break
            except Exception:
            ...
            raise AssertionError('click falhou: ' + str(['button[aria-label="03/02/1970"]', 'button:has-text("3")', 'button.mat-calendar-body-cell.mat-calendar-body-active']))
        ' Passo 10: click'
        ...
        ' Passo 13: assert'
        ' Seletores: p:has-text("R$\xa0155.144,02") | p.text-grayscale-130.text-size-small.m-0.mb-4'
        expect(page.locator('p:has-text("R$\xa0155.144,02")')).to_contain_text('R$\xa0155.144,02')