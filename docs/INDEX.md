...
- [Instalação](USER-GUIDE/INSTALL.md) — Guia de instalação passo a passo (Windows e Linux)
- [Interface Gráfica](USER-GUIDE/GUI-LAUNCHER.md) — Como abrir e usar o `testforge-gui`
- [Guia Completo de Gravação](USER-GUIDE/GRAVAR-FLUXO.md) — Fluxo completo: overlay, asserts (Text/State/Visible/Auto/Error), atalhos, pós-gravação
- [Quick Start](USER-GUIDE/QUICK-START.md) — Grave seu primeiro teste em 5 minutos
...
- [Workflow do QA](TUTORIAIS/qa-workflow.md) — Jornada fim-a-fim: instalar → gravar → validar → publicar
...
- [Diagramas PlantUML](diagramas/) — 20+ diagramas C4, componentes, classes, estados, sequências, handlers (`.puml` + `.png`)
...
- [Arquivos da Gravação](REFERENCIA/RECORDING-FILES.md) — Legenda completa de todos os artefatos gerados por uma gravação
- [Glossário](REFERENCIA/GLOSSARY.md) — Termos técnicos explicados em linguagem simples
- [Bugs Conhecidos e Resolvidos](REFERENCIA/BUGS-KNOWNS.md) — 30+ bugs corrigidos (Sprint 0), limitações
