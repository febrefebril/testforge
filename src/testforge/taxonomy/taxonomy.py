...
KEYWORD_PATTERNS: list[tuple[str, str, str]] = [
    ...
    ("nao encontrado no dom", "FAM-01", "SEL-004"),
    ("elemento nao encontrado", "FAM-01", "SEL-004"),
    ("nao encontrado", "FAM-01", "SEL-004"),
    ("nao esta no dom", "FAM-01", "SEL-004"),
    ("not_attached", "FAM-01", "SEL-001"),
