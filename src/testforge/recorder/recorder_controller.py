...
def _get_testforge_version() -> str:
    """Return current testforge version string for overlay display."""
    try:
        from importlib.metadata import version as _importlib_version
        return _importlib_version("testforge")
    except Exception:
...
class RecorderController:
    ...
    def start(
        ...
        context_script = (
            ...
            " };"
            f"window.__tfVersion = {json.dumps(_get_testforge_version())};"
    ...
    def flush_events(self):
        ...
        try:
            ...
            # NB-03: inject external step count for cross-origin navigation
            try:
                self._page.evaluate(f"window.__tfExternalStepCount = {self._step_counter}")
            except Exception:
                pass
    ...
    def finalize(self) -> RecordingSession:
        ...
        try:
            ...
            pass
        try:
            self._store.sort_events_by_timestamp()
        except Exception:
            pass
    ...
    def _on_framenavigated(self, frame):
        ...
        try:
            ...
            page_title = ""
        # Skip navigations where the URL hasn't changed (reloads, CONSULTA flicker)
