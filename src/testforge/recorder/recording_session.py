...
class RecordingSession:
    recording_id: str
    application: str = ""
    # REC-80: preferred enum over 'application' (web/mobile/desktop/api).
    # 'application' is kept for backward compat but deprecated — it was
    # historically misused as a system name (e.g. "SIMULADOR").
    ...
    # Hierarchical classification: system/suite/test_case/scenario.
    # Used by Git publisher to build recordings/{system}/{suite}/{test_case}/{id} paths.
    # scenario is the fourth level (REC-22): optional sub-test-case grouping.
    system: str = ""
    suite: str = ""
    test_case: str = ""
    scenario: str = ""
...
class RecordingSessionManager:
    ...
    def start(self, recording_id: str, application: str = "",
              ...
              test_case: str = "", scenario: str = "") -> RecordingSession:
