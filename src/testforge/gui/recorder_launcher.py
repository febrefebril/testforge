...
class RecorderLauncher(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title(f"TestForge v{_tf_version}")
    ...
    def _build_ui(self):
        ...
        tk.Label(self, text=f"TestForge v{_tf_version}  ·  Gravador de Testes",
    ...
    def _build_cmd(self):
        ...
        # Sempre --no-interactive: GUI nao tem stdin, input() bloquearia
