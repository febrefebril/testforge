...
<required_reading>
@/home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/references/domain-probes.md
@/home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/references/gate-prompts.md
@/home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/references/universal-anti-patterns.md
</required_reading>
...
if [ -f "/home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/USER-PROFILE.md" ]; then
  ADVISOR_MODE=true
else
  ADVISOR_MODE=false
fi
...
Read `@/home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/references/scout-codebase.md` — it contains the phase-type→map selection table, single-read rule, no-maps fallback, and `<codebase_context>` output schema. Then execute:
