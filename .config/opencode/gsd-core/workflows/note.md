...
- **Global scope**: `/home/febre/Projetos/testforge-v1/.config/opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/febre/Projetos/testforge-v1/.config/opencode/notes/`)
...
2. Glob `/home/febre/Projetos/testforge-v1/.config/opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/febre/Projetos/testforge-v1/.config/opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/febre/Projetos/testforge-v1/.config/opencode/notes/` — works in any directory
