...
<required_reading>
@/home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/references/ai-frameworks.md
@/home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/febre/Projetos/testforge-v1/.config/opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/febre/Projetos/testforge-v1/.config/opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/febre/Projetos/testforge-v1/.config/opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/febre/Projetos/testforge-v1/.config/opencode/agents/gsd-eval-planner.md for instructions.
