...
<template>
@/home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/workflows/transition.md`.
...
- Follow @/home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/workflows/diagnose-issues.md
