...
INSTALL_JS_GLOBAL="/home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
