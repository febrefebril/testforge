...
<required_reading>
@/home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/references/user-story-template.md
@/home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/references/spidr-splitting.md
@/home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `question` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@/home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/references/spidr-splitting.md`. Briefly:
