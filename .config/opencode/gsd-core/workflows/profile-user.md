...
Key references:
- @/home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/references/ui-brand.md (display patterns)
- @/home/febre/Projetos/testforge-v1/.config/opencode/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/USER-PROFILE.md"
...
```bash
cp "/home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/USER-PROFILE.md" "/home/febre/Projetos/testforge-v1/.config/opencode/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/references/user-profiling.md`
...
Reference: @/home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /home/febre/Projetos/testforge-v1/.config/opencode/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /home/febre/Projetos/testforge-v1/.config/opencode/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /home/febre/Projetos/testforge-v1/.config/opencode/AGENTS.md"
...
```bash
BACKUP_PATH="/home/febre/Projetos/testforge-v1/.config/opencode/USER-PROFILE.backup.md"
```
...
Your profile:    /home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /home/febre/Projetos/testforge-v1/.config/opencode/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        /home/febre/Projetos/testforge-v1/.config/opencode/AGENTS.md
```
