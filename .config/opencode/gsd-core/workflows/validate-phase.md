...
```
Agent(
  prompt="Read /home/febre/Projetos/testforge-v1/.config/opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/templates/VALIDATION.md`
