...
<required_reading>
Read `/home/febre/Projetos/testforge-v1/.config/opencode/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
